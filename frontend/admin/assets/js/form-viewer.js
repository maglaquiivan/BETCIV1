...
function openApplicationFormWithData(appData) {
    ...
    let formHTML = `
        ...
        <div id="formFooter" style="padding: 20px 30px; background: #f9f9f9; border-top: 1px solid #eee; display: flex; gap: 10px; justify-content: flex-end; flex-wrap: wrap; position: sticky; bottom: 0;">
            <button onclick="deleteApplicationForm('${appData._id || appData.id}')" style="padding: 10px 20px; background: #e74c3c; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; font-size: 13px; display: flex; align-items: center; gap: 6px; transition: all 0.3s ease;">
...
function deleteApplicationForm(applicationId) {
    alert('Delete functionality is not supported by the backend API yet. Please contact your administrator to implement this feature.');
}

// Delete admission form
function deleteAdmissionForm(admissionId) {
    alert('Delete functionality is not supported by the backend API yet. Please contact your administrator to implement this feature.');
}
...
function openAdmissionFormWithData(admissionData) {
    ...
    let formHTML = `
        ...
        <div id="formFooter" style="padding: 20px 30px; background: #f9f9f9; border-top: 1px solid #eee; display: flex; gap: 10px; justify-content: flex-end; flex-wrap: wrap; position: sticky; bottom: 0;">
            <button onclick="deleteAdmissionForm('${admissionData._id || admissionData.id}')" style="padding: 10px 20px; background: #e74c3c; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; font-size: 13px; display: flex; align-items: center; gap: 6px; transition: all 0.3s ease;">
                <i class="bi bi-trash"></i> Delete
            </button>
            <button onclick="closeFormModal()" style="padding: 10px 20px; background: #757575; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; font-size: 13px; display: flex; align-items: center; gap: 6px; transition: all 0.3s ease;">
                <i class="bi bi-x-lg"></i> Close
